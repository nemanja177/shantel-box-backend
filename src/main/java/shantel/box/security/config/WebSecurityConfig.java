package shantel.box.security.config;
...
import shantel.box.security.auth.RestAuthenticationEntryPoint;
import shantel.box.security.auth.TokenAuthenticationFilter;
...
//
//        configuration.setAllowedOrigins(ImmutableList.of("https://bigalslist.com")); // www - obligatory
...
//    }
	...
	@Autowired
	private KorisnikServiceImpl jwtKorisnikService;
	...
	public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
		auth.userDetailsService(jwtKorisnikService).passwordEncoder(passwordEncoder());
	}
...
//		http.cors().and().csrf().disable();
		http
				...
				.authorizeRequests().antMatchers("/**").permitAll().antMatchers("/auth/**").permitAll().antMatchers("/box/bodovi/**").permitAll()
				...
				.addFilterBefore(new TokenAuthenticationFilter(tokenUtils, jwtKorisnikService),
	...
	public void configure(WebSecurity web) throws Exception {
		...
		web.ignoring().antMatchers(HttpMethod.POST, "/box/auth/login");
